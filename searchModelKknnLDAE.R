...
#            11) Use ME/VE in favor of VE/SU/MA for weak learner 4.
#            12) Use SU/MA in favor of MA/JU for weak learner 5.
...
useFeatures5 <- allFeatures[grep('^SU|^MA', allFeatures)]
...
fwrite(dailyAspects[, ..exportCols], paste("~/Desktop/", symbol, "-predict-kknnLDAF-ensamble", ".csv", sep = ""))
