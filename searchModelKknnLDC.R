...
#             1) Planets MO, ME, VE, SU, MA fast planets applying to all slow planets except NN.
...
#            15) Split rounded orb aspect factors.
...
dailyAspects <- dailyCombPlanetAspectsFactorsTableLDC(
  orbLimit = 2,
  pxSelect = pxSelect,
  pySelect = pySelect,
...
fwrite(dailyAspects[, ..exportCols], paste("./predictions/", symbol, "-predict-kknnLDC-ensamble", ".csv", sep = ""))
