...
#             9) GA feature selection popSize = 30 and iter = 10.
...
#            13) GA search separative orb limit 1-3 degrees.
#            14) Z diff percent cut to 3.
#            15) Remove pxSelect from GA search.
#            16) GA fit validate repeats to 10.
...
modelId <- "ensamble-gakknn-MAABBAABCACC"
zdiffPercentCut <- 3
maPriceFsPeriod <- 2
maPriceSlPeriod <- 3
