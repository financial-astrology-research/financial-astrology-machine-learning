...
#            11) K set to 10.
#            12) Include MO, ME, VE, SU, MA longitude to allow energy type detection.
...
dailyPositions <- hourlyPlanets[, lapply(.SD, mean), .SDcols = selectLonColumns, by = 'Date']
