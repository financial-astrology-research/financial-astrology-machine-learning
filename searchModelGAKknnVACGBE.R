...
#            14) Minor aspects set: 45/135/150, Medium: 30/60/90/120/180, Major: 0
...
modelId <- "ensamble-gakknn-VACGBE"
zscoreCut <- 2
maPriceFsPeriod <- 2
maPriceSlPeriod <- 3
...
dailyAspectsRows[aspect %in% c(30, 60, 90, 120, 180) & orb > 3, filter := T]
