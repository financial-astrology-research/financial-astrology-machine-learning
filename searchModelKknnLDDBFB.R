...
#             1) Planets ME, VE, SU, MA fast planets applying to all slow planets, NN and CE.
...
#             9) Use harmonics with NN and asteroids CE.
...
longitudeHarmonicsColumns <- columnNames[grep(str_flatten(paste0('^', c('MO', 'ME', 'VE', 'SU'), 'LONH0', '$'), "|"), columnNames)]
