...
#            11) Aspect energy with orb decay.
#            11) GA solution aspect energy search within 1-4 interval.
#            12) K set to 8.
#            13) Z price diff cut set to 2.5.
...
searchModel <- function(symbol) {
  ...
  gar <- ga(
    ...
    lower = c(rep(0, 13), rep(1, gaParamsNum-13)),
