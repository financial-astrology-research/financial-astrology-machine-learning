# Title     : Daily planet generalized planet X (emitter) detailed aspects count KNN regression model
...
#             2) CV folds to 5 with 10 repeats for weak learners,
#                folds to 10 with 10 repeats for ensamble.
...
#            11) Zscore price diff cut set to 1.5.
#            12) Glm method for ensamble train.
