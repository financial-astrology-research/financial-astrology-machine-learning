...
#            15) Add NE max/min norm declination features to model data.

# TODO: Looks promising, use as root for a new generation of models.
...
modelId <- "ensamble-kknn-MAABBAABCACCCLIK"
zdiffPercentCut <- 3
maPriceFsPeriod <- 2
maPriceSlPeriod <- 3
