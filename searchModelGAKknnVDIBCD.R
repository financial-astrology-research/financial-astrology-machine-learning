...
#                and filtered to 3 (major), 2 (minor) for this model.
#            13) Minor aspects set: 120/135/150/180, Medium: 0/30/45/60/90
...
modelId <- "ensamble-gakknn-VDIBCD"
zscoreCut <- 2
maPriceFsPeriod <- 2
maPriceSlPeriod <- 3
...
dailyAspectsRows[aspect %in% c(0, 30, 45, 60, 90) & orb > 3, filter := T]
