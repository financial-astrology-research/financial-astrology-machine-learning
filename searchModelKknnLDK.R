# Title     : Daily generalized aspects energy sum and combined planets activation boolean flag.
...
dailyAspectsEnergy <- dailyAspectsGeneralizedEnergySum(
  orbLimit = orbLimit,
  pxSelect = pxSelect,
  pySelect = pySelect
)
...
dailyAspects <- merge(dailyAspectsEnergy, dailyAspectsPlanetsActivation, by = "Date")
...
fwrite(dailyAspects[, ..exportCols], paste("./predictions/", symbol, "-predict-kknnLDK-ensamble", ".csv", sep = ""))
