...
drawFastIndicators <- function () {
  p <- ggplot(data=dailyPlanetsResearch) +
     ...
     geom_point(aes(x=Date, y=SAURLON, size=1), colour="maroon", alpha=0.6, size=1) +
     ...
     geom_hline(yintercept = 170, linetype="solid", color="magenta2", size=1, alpha=0.7) +
     ...
     geom_hline(yintercept = 10, linetype="solid", color="magenta2", size=1, alpha=0.7) +
