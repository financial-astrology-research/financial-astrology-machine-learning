# Title     : Daily planet generalized planet Y (receiver) detailed aspects count KNN regression model
...
#             1) Planets MO, ME, VE, SU, MA fast planets applying to all slow planets, VS.
#             2) CV folds to 5 with 5 repeats for weak learners, folds to 10 with 10 repeats for ensamble.
...
#            11) Zscore diff percent cut to 1.5.
