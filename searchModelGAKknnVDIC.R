...
#                and filtered to 5 (major), 3 (medium), 2 (minor) for this model.
#            13) Minor aspects set: 135/150/180, Medium: 30/45/60/90/120 Major: 0
...
dailyAspectsRows[aspect %in% c(30, 45, 60, 90, 120) & orb > 3, filter := T]
dailyAspectsRows[aspect %in% c(0) & orb > 5, filter := T]
