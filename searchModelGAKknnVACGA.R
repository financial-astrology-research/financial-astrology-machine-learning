...
#            13) Increase default aspects orb limit to 4.
#            12) Use minor aspects, 60 and 150 within 2 degree orb only.
#            13) New aspects set were all aspects orbs are calculated with 6 degrees orb
#                and filtered to 4 (major) and 2 (minor) for this model.
...
# Filter minor aspects with orb greater than 1 degree.
dailyAspectsRows$filter <- F
dailyAspectsRows[aspect %in% c(30, 45, 60, 135, 150) & orb > 2, filter := T]
