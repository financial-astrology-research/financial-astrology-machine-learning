...
#             1) Planets ME, SU fast planets applying to all slow planets except NN.
...
fwrite(dailyAspects[, ..exportCols], paste("./predictions/", symbol, "-predict-kknnLDDD-ensamble", ".csv", sep = ""))
