...
#            13) Minor aspects set: 135/150/180, Medium: 60/120 Major: 0/30/45/90
...
modelId <- "ensamble-gakknn-VDIBCE"
zscoreCut <- 2
maPriceFsPeriod <- 2
maPriceSlPeriod <- 3
...
dailyAspectsRows[aspect %in% c(135, 150, 180) & orb > 1, filter := T]
dailyAspectsRows[aspect %in% c(60, 120) & orb > 2, filter := T]
dailyAspectsRows[aspect %in% c(0, 30, 45, 90) & orb > 4, filter := T]
