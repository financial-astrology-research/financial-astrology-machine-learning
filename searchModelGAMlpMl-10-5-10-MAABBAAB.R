# Title     : Daily generalized aspects / planet Y activation count mlpML regression model
...
#            14) Architecture h1-10, h2-5, h3-10.
...
modelId <- "ensamble-ga-mlpML-10-5-10-MAABBAAB"
zdiffPercentCut <- 3
maPriceFsPeriod <- 2
maPriceSlPeriod <- 3
