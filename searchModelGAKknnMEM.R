...
#            12) Aspects energy weight (with orb decay) GA optimization search.
#            13) Energy weight within range -2 to 2.
...
searchModel <- function(symbol) {
  ...
  gar <- ga(
    ...
    lower = c(rep(0, 4), rep(-2, 10)),
    upper = c(rep(1, 4), rep(2, 10)),
