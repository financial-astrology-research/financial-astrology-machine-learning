...
#            14) Minor aspects set: 45/135/150, Medium: 30/180, Major: 0/60/90/120
...
modelId <- "ensamble-gakknn-VACGBFC"
zscoreCut <- 2
maPriceFsPeriod <- 2
maPriceSlPeriod <- 3
...
dailyAspectsRows[aspect %in% c(45, 135, 150) & orb > 2, filter := T]
dailyAspectsRows[aspect %in% c(30, 180) & orb > 3, filter := T]
