...
#            13) Orb limit to 4.
#            14) Separative orb limit to 4.
#            15) Modern aspect set 4 (minor aspects orb to 2).
...
modelId <- "ensamble-kknn-MAABBAABCACCCO"
zdiffPercentCut <- 3
maPriceFsPeriod <- 2
maPriceSlPeriod <- 3
