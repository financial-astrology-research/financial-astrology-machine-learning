# Title     : Daily planets aspects activation X/Y generalized count.
...
dailyAspectsPlanetsActivationY <- dailyPlanetYActivationCount(
  orbLimit = orbLimit,
  pxSelect = pxSelect,
  pySelect = pySelect
)

dailyAspectsPlanetsActivationX <- dailyPlanetXActivationCount(
  orbLimit = orbLimit,
  pxSelect = pxSelect,
  pySelect = pySelect
)

dailyAspects <- merge(dailyAspectsPlanetsActivationX, dailyAspectsPlanetsActivationY, by = "Date")
...
fwrite(dailyAspects[, ..exportCols], paste("./predictions/", symbol, "-predict-kknnLDL-ensamble", ".csv", sep = ""))
