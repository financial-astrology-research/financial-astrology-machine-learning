...
#             1) Planets MO, ME, VE, SU fast planets applying to all slow planets, asteroids and NN.
...
searchModel <- function(symbol) {
  ...
  gar <- ga(
    ...
    lower = c(rep(0, 4), rep(-3, 10)),
    upper = c(rep(1, 4), rep(3, 10)),
