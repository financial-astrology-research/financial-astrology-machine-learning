...
#            11) Zscore price diff cut to 1.5.
#            12) Limit GA selection to PX select.
#            13) GA uniform crossover method.
...
searchModel <- function(symbol) {
  ...
  parseSolutionParameters <- function(solution) {
    pxSelect <- pxSelectAll[solution[1:nBits] == 1]
