...
#            14) Minor aspects set: 45/135/150, Medium: 30/60/120, Major: 0/90/180
...
modelId <- "ensamble-gakknn-VACGBG"
zscoreCut <- 2
maPriceFsPeriod <- 2
maPriceSlPeriod <- 3
...
dailyAspectsRows[aspect %in% c(30, 60, 120) & orb > 3, filter := T]
dailyAspectsRows[aspect %in% c(0, 90, 180) & orb > 4, filter := T]
