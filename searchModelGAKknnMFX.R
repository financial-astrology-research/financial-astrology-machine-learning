...
#             1) Planets MO, ME, VE fast planets applying to all slow planets, VS and NN.
...
#            12) Include aspects in GA solution parameters search.
...
searchModel <- function(symbol) {
  ...
  parseSolutionParameters <- function(solution) {
    ...
    aspectSelect <- aspectSelectAll[solution[12:nBits] == 1]
