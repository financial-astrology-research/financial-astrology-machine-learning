...
#            13) Minor aspects set: 120/135/150/180, Medium: 30/45/60/90 Major: 0
...
dailyAspectsRows[aspect %in% c(30, 45, 60, 90) & orb > 3, filter := T]
dailyAspectsRows[aspect %in% c(0) & orb > 4, filter := T]
