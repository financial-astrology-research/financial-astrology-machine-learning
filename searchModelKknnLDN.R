# Title     : Daily planets X emitted aspects count.
#             1) Planets MO, ME, VE fast planets applying to planets slower than SU (including).
...
fwrite(dailyAspects[, ..exportCols], paste("./predictions/", symbol, "-predict-kknnLDN-ensamble", ".csv", sep = ""))
