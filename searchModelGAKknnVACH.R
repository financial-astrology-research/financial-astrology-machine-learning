...
#            12) Use minor aspects within 2 degree orb and only within minor planets.
...
# Filter minor aspects with orb greater than 2 degrees and targeting major planets.
dailyAspectsRows$filter <- F
dailyAspectsRows[aspect %in% c(30, 45, 135) & orb > 2, filter := T]
dailyAspectsRows[aspect %in% c(30, 45, 135) & p.y %ni% pxSelectAll, filter := T]
