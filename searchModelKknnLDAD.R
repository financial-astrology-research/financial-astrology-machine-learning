...
#             1) Planets MO, ME, VE, SU, MA, JU fast planets applying to all slow planets.
...
useFeatures3 <- allFeatures[grep('^VE|^SU|^MA', allFeatures)]
...
fwrite(dailyAspects[, ..exportCols], paste("./predictions/", symbol, "-predict-kknnLDAD-ensamble", ".csv", sep = ""))
