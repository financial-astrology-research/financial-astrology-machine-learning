...
modelId <- "ensamble-gakknn-MAABBAABCACB"
zdiffPercentCut <- 3
maPriceFsPeriod <- 2
maPriceSlPeriod <- 3
...
searchModel <- function(symbol) {
  ...
  gar <- ga(
    ...
    lower = rep(1, gaParamsNum),
    upper = rep(3, gaParamsNum),
