...
#             1) Planets ME, VE, SU, MA, CE, VS, JU, SA planets applying to all planets and VS.
...
#            13) Increase aspects orb limit to 4.
...
searchModel <- function(symbol) {
  ...
  prepareDailyAspects <- function(pxSelect, pySelect, aspectSelect, sepAspectsOrb) {
  ...
  prepareModelData <- function(params) {
    c(pxSelect, pySelect, aspectSelect, sepAspectsOrb) %<-% params
    dailyAspects <- prepareDailyAspects(pxSelect, pySelect, aspectSelect, sepAspectsOrb)
  ...
  modelTrain <- function(params) {
    c(pxSelect, pySelect, aspectSelect, sepAspectsOrb) %<-% params
    cat("Using PX:", pxSelect, "- PY:", pySelect, "- ASP:", aspectSelect, "- SORB:", sepAspectsOrb, "\n")
  ...
  parseSolutionParameters <- function(solution) {
    ...
    pySelect <- pySelectAll[solution[2:gaParamsNum] == 1]
