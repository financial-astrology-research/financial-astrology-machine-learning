# Title     : Search XGB linear model fit for planetY/aspect pair generic count.
# Created by: pablocc
...
fwrite(dailyAspects, paste("./predictions/", symbol, "-predict-xgblinearLG-ensamble", ".csv", sep = ""))
