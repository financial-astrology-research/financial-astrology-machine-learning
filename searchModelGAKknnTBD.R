# Title     : Daily generalized aspects count + PY activation energy (orb decay) data KNN regression model
...
#            12) Modern mix aspects set.
#            13) Orb limit set to 4.
...
searchModel <- function(symbol) {
  ...
  prepareDailyAspects <- function(pxSelect, pySelect, aspectSelect) {
    ...
    dailyAspects <- merge(dailyAspectsGeneralizedCount, dailyPlanetYActivationEnergy, date = "Date")
