# Title     : Search XGB linear model fit for planetX/aspect pair generic count.
# Created by: pablocc
...
fwrite(dailyAspects, paste("./predictions/", symbol, "-predict-xgblinearLF-ensamble", ".csv", sep = ""))
