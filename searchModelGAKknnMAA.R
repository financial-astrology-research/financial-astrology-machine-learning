...
#             2) Weak learners CV folds to 5 with 2 repeats, ensamble folds to 10 with 10 repeats.
...
fwrite(dailyAspects[, ..exportCols], paste("~/Desktop/", symbol, "-predict-ensamble-gakknn-MAA", ".csv", sep = ""))
