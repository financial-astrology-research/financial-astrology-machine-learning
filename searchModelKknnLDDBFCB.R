...
#             1) Planets MO, ME, VE, SU, MA fast planets applying to all slow planets, NN, SN and CE, VS.
...
#            10) Use ME/VE/SU/MA/CE/VS longitude harmonic 3 to allow model detect zodiac energy.
...
longitudeHarmonicsColumns <- columnNames[grep(str_flatten(paste0('^', pLonSelect, 'LONH0', '$'), "|"), columnNames)]
