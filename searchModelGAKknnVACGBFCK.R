...
#            14) Minor aspects set: 135/150/180, Medium: 30/45 Major: 0/60/90/120
...
modelId <- "ensamble-gakknn-VACGBFCK"
zscoreCut <- 2
maPriceFsPeriod <- 2
maPriceSlPeriod <- 3
...
dailyAspectsRows[aspect %in% c(0, 60, 90, 120) & orb > 5, filter := T]
