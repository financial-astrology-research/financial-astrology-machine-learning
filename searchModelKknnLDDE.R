...
#             1) Planets VE, SU fast planets applying to all slow planets except NN.
...
fwrite(dailyAspects[, ..exportCols], paste("./predictions/", symbol, "-predict-kknnLDDE-ensamble", ".csv", sep = ""))
