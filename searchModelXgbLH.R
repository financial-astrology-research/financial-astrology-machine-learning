# Title     : Search XGB linear model using generalized aspects and planet combination activation count data.
# Created by: pablocc
...
fwrite(dailyAspects, paste("./predictions/", symbol, "-predict-xgblinearLH-ensamble", ".csv", sep = ""))
