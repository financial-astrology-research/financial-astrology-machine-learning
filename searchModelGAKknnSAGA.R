# Title     : Daily PX received aspects count data KNN regression model
...
#             1) Planets MO, ME, VE fast planets applying to all planets and VS, JN, CE, PA, CH, PH.
