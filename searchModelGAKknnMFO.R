...
#             1) Planets MO, ME, VE, SU fast planets applying all planets, VS and NN.
...
#            12) Limit GA search to pxSelect planets, use all in pySelect.
