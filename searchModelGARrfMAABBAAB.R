# Title     : Daily generalized aspects / planet Y activation count RRF regression model
...
#             9) GA feature selection popSize = 50 and iter = 5.
...
modelId <- "ensamble-ga-RRF-MAABBAAB"
zdiffPercentCut <- 3
maPriceFsPeriod <- 2
maPriceSlPeriod <- 3
