# Title     : Daily combined planets activation boolean flag.
...
dailyAspects <- dailyAspectsPlanetCombGeneralizedCount(
  orbLimit = orbLimit,
  pxSelect = pxSelect,
  pySelect = pySelect,
...
fwrite(dailyAspects[, ..exportCols], paste("./predictions/", symbol, "-predict-kknnLDJK-ensamble", ".csv", sep = ""))
