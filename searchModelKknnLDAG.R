...
#            12) Use ME/VE/SU for 1 weak learners.
#            13) Use ME/VE/MA for 1 weak learners.
#            14) Use ME/VE/SU/MA for 1 weak learner.
...
useFeatures4 <- allFeatures[grep('^ME|^VE|^MA', allFeatures)]
...
fwrite(dailyAspects[, ..exportCols], paste("./predictions/", symbol, "-predict-kknnLDAG-ensamble", ".csv", sep = ""))
