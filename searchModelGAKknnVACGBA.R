...
#            12) Use minor aspects - 30 + 150 within 2 degree orb only.
...
# TODO: Continue variations from this:
# - Use 150 within orb 3.
# - Remove PL from pySelect.
# - Remove VS from pySelect.
# - Add CH to pySelect.
# - Add CE to pySelect.
modelId <- "ensamble-gakknn-VACGBA"
zscoreCut <- 2
maPriceFsPeriod <- 2
maPriceSlPeriod <- 3
