...
#            14) Minor aspects set: 135/150/180, Medium: 90/120 Major: 0/30/45/60
...
modelId <- "ensamble-gakknn-VACGBFCJ"
zscoreCut <- 2
maPriceFsPeriod <- 2
maPriceSlPeriod <- 3
...
dailyAspectsRows[aspect %in% c(90, 120) & orb > 3, filter := T]
dailyAspectsRows[aspect %in% c(0, 30, 45, 60) & orb > 4, filter := T]
