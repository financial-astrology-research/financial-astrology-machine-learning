...
#             1) Planets MO, ME, VE, SU, MA fast planets applying to all planets and VS.
...
#                and filtered to 4 (major), 2 (medium), 1 (minor) for this model.
#            13) Minor aspects set: 30/45/135 Medium: 60/120/150/180 Major: 0/90
#            14) Ignore separative aspects with orb > 1.
...
dailyAspectsRows[aspect %in% c(60, 120, 150, 180) & orb > 3, filter := T]
