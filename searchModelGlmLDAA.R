...
#             5) Ignore observations with low price diff zscore < 0.05 for train
...
securityData <- securityData[abs(zdiffPercent) > 0.05]
...
fwrite(dailyAspects[, ..exportCols], paste("./predictions/", symbol, "-predict-glmLDAA-ensamble", ".csv", sep = ""))
