...
searchModel <- function(symbol) {
  ...
  prepareDailyAspects <- function(pxSelect, pySelect, aspectSelect, aspectWeight, orbLimit) {
  ...
  prepareModelData <- function(params) {
    c(pxSelect, pySelect, aspectSelect, aspectWeight, orbLimit) %<-% params
    dailyAspects <- prepareDailyAspects(pxSelect, pySelect, aspectSelect, aspectWeight, orbLimit)
  ...
  modelTrain <- function(params) {
    c(pxSelect, pySelect, aspectSelect, aspectWeight, orbLimit) %<-% params
    cat("Using PX:", pxSelect, "- PY:", pySelect, "- ASP:", aspectWeight, " - ORB:", orbLimit, "\n")
  ...
  parseSolutionParameters <- function(solution) {
    ...
    orbLimit <- solution[1]
    aspectWeight <- solution[2:gaParamsNum] / 10
