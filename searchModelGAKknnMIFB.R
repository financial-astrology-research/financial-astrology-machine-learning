...
#            11) GA solution aspect energy search within -3-3 interval.
...
searchModel <- function(symbol) {
  ...
  gar <- ga(
    ...
    lower = c(rep(0, 13), rep(-3, gaParamsNum-13)),
    upper = c(rep(1, 13), rep(3, gaParamsNum-13)),
